...
if (!apikey) return res.json(loghandler.notapikey)
if(listkey.includes(apikey)){
let anu = await fetchJson(`https://api.lolhuman.xyz/api/ytplay2?apikey=${lolkey}&query=${q}`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
...
if (!apikey) return res.json(loghandler.notapikey)
if(listkey.includes(apikey)){
let anu = await fetchJson(`https://api.lolhuman.xyz/api/ytaudio2?apikey=${lolkey}&url=${url}`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
...
if (!apikey) return res.json(loghandler.notapikey)
if(listkey.includes(apikey)){
let anu = await fetchJson(`https://api.lolhuman.xyz/api/ytvideo2?apikey=${lolkey}&url=${url}`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
